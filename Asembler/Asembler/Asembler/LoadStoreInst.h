...
template<int kod_operacije>
inline void LoadStoreInst<kod_operacije>::obradi(std::string s, IzlazniFile& it)
{
	std::cmatch m;
	int reg1;
...
template<int kod_operacije>
inline int LoadStoreInst<kod_operacije>::dohvati_duzinu_instrukcije(std::string s) const
{
...
template<int kod_operacije>
inline int LoadStoreInst<kod_operacije>::dohvati_broj(std::string broj) const
{
